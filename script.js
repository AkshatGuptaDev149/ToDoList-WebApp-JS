//Message
console.log('All your Tasks are stored in localstorage')
console.log('Sorry,currently this web is not responsive.Please try running in PC only for best experience.')
...
let content;
let title;
//Managing Task title enter button
